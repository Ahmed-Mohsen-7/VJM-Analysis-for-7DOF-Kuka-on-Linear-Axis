...
% clc
% Link lengths
addpath('D:\Innopolis_University\Semester2\Advanced Robotics\Project\Task2\utils')
link_lengths = [0.675, 0.350, 1.150, 1.200, -0.041, 0.240];
...
for i = 1:length(t)/10 
    ...
    qs(:,i) = IK(pose,q_start,link_lengths'); 
